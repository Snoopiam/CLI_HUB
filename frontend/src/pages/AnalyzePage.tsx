 ...
 * =============================================================================
 *
 * The core page of PRISM. Clean, focused, purposeful.
 * =============================================================================
 */
            ...
            >
              ...
              >
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-5">
                  {[
                    { icon: '◎', text: 'Be specific about technologies (React, Python, etc.)', accent: true },
                    { icon: '◆', text: 'Mention your goals (debug, test, deploy, etc.)', accent: false },
                    { icon: '✦', text: 'Include context (API, database, frontend, etc.)', accent: true },
                  ].map((tip, index) => (
                    <motion.div
                      key={index}
                      initial={{ opacity: 0, y: 20 }}
